...
#  MA  02110-1301, USA.
"""
This is modified version of https://github.com/bitcraze/crazyflie-lib-python/blob/master/examples/swarm/synchronizedSequence.py
...
sequence_1 = [
    (0,    0,      Ring(255, 0, 0, 1, 0)),#RED
    (1,    0,      Ring(0, 255, 0, 1, 0)),#GREEN
    (2,    0,      Ring(0, 0, 255, 1, 0)),#BLUE
    (3,    0,      Ring(0, 0, 0, 0, 0)),
]
...
sequence_3 = [
    (0, 0, Ring(255, 255, 255, 1, 0)),#WHITE
    (0, 0, Takeoff(1.5, 3)),
    (6, 0, Goto(0, 0.3,1.5 ,STEP_TIME)),
    (7, 0, Goto(0.3, 0.3 ,1.5 ,STEP_TIME)),
    (8, 0, Goto(0.3 ,0 ,1.5 ,STEP_TIME)),
    (9, 0, Goto(0 ,0 ,1.5 ,STEP_TIME)),
    (10, 0, Land(3)),
    (10, 0, Ring(0, 0, 0, 0, 0)),#LED OFF
]
    ...
    while not sequence_stop:
        ...
        if key_input == 'q': 
            ...
            if(key_input == 'init'):
                ...
                cur_sequence = sequence_1
            elif(key_input == '2'):
                cur_sequence = sequence_2
            elif(key_input == '3'):
                cur_sequence = sequence_3
            elif(key_input == '4'):
                cur_sequence = sequence_4
            else:
                cur_sequence = sequence_init
